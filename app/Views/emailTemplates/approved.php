...
<body>
    ...
    padding: 0px 0px 0px 107px;">
                                ...
                                <td style="padding: 15px 0px; position: absolute; margin-left: 128px;">
                                        <img src="<?= base_url('public/uploads/' . $user->Photo) ?>" alt="Profile Image" style="outline: none;
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center; padding:15px;">
                                ...
                                <p style="line-height: 23px; font-size: 15px; padding: 5px 0 0px; text-align:justify;">Congratulations on attaining the approval status for your UCLF-MiS Account, the approval is only awarded to only those who have diligently provided the required information.
                                </p>
                                <p style="line-height: 23px; font-size: 15px; padding: 0px 0 5px; ">Below is the approval remark made:
                                </p>
                                <p class="commentDisplay"><?php echo $review['comment']?></p>
