                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center; padding:15px;">
                                ...
                                <p style="line-height: 23px; font-size: 15px; padding: 5px 0 0px; text-align:justify;">On behalf of the entire UCLF Body, we hereby inform you that your account has been <b>SUSPENDED</b>. You are therefore unable to log into the UCLF-MiS anymore.
                                </p>
