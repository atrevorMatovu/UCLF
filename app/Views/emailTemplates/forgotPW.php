                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center; padding:15px;">
                                ...
                                <p style="line-height: 23px; font-size: 15px; padding: 5px 0 0px; text-align:justify;">Thank you for joining our fraternity.Kindly follow the procedure below 
                                    <br>Your change password request has been received. Please click the link below to change your password.</br>
                                    <br>Please note! <strong>This link is valid for only 24 hours</strong>.
                                </p>
                               
                                <p class="commentDisplay"><button class="btn-pri">Change password</a></button></p>
                                <p>OR</p>
