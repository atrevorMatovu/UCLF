            ...
            <li>
              ...
              ?>
               ...
               <form action="http://localhost/UCLF/noti" method="post" name="UpdateNotifications" enctype="multipart/form-data" accept-charset="utf-8"> 
                  ...
                  <button class="btn" type="submit"><i class="jc-end bi <?php echo ($recentnotif['status'] === '1') ? 'bi-exclamation-circle' : 'bi-exclamation-circle-fill'; ?>"></i></button>
                </form>
                <div class="fs-notif ">
              <?php 
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card ">
                ...
                <div class="card-body ">
                  <h5 class="card-title ">Members <span>| Currently</span></h5>
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $members?></h6><span class="text-muted small pt-2 ps-1">Members</span>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Stats <span>|Currently</span></h5>
                  
                  <div id="trafficChart" style="min-height: 300px;" class="echart"></div>
                  
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  const membershipData = <?= json_encode($mt)?>; // Get the JSON data
